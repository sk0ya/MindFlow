...
jest.mock('../../features/collaboration/realtimeSync.js', () => ({
  realtimeSync: {
    updateMap: jest.fn(),
    deleteMap: jest.fn()
  }
...
describe('useMindMapMulti - Map Switching Tests', () => {
  ...
  beforeEach(() => {
    ...
    const { getCurrentAdapter } = require('../../core/storage/storageAdapter.js');
    getCurrentAdapter.mockReturnValue(mockAdapter);

    // Reset storage router mocks
    const storageRouter = require('../../core/storage/storageRouter.js');
