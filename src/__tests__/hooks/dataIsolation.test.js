...
import { assignColorsToExistingNodes } from '../../shared/types/dataTypes';

// Mock the storage modules
jest.mock('../../core/storage/storageRouter', () => ({
...
jest.mock('../../shared/types/dataTypes', () => {
  const original = jest.requireActual('../../shared/types/dataTypes');
  return {
    ...original,
...
describe('Data Isolation Tests', () => {
  ...
  beforeEach(() => {
    ...
    const { getCurrentAdapter } = require('../../core/storage/storageAdapter');
