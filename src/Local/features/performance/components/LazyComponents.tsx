...
const LazyCustomizationPanel = lazy(() => import('../../mindmap/components/NodeCustomizationPanel'));
const LazyContextMenu = lazy(() => import('../../../shared/components/ui/ContextMenu'));
const LazyImageModal = lazy(() => import('../../files/components/ImageModal'));
const LazyFileActionMenu = lazy(() => import('../../files/components/FileActionMenu'));
